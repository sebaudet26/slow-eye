        ...
        <ReactTableFixedColumns
          ...
          columns={[
              ...
              Cell: row => (
                <a href={`./team?id=${row.value.split('+')[2]}`}>
                  <svg key={Math.random()} className="team-cell-logo">
                    <use xlinkHref={`/public/images/teams/season/20182019.svg#team-${row.value.split('+')[2]}-20182019-light`} />
                  </svg>
            ...
            },
            {
              Header: 'GP',
              id: 'gamesPlayed',
              accessor: d => Number(d.gamesPlayed),
              maxWidth: 65,
              minWidth: 35,
            },
            {
            ...
            },
            {
              Header: 'GA',
              id: 'goalsagainst',
              accessor: d => Math.round(d.gamesPlayed * d.goalsAgainstPerGame),
              maxWidth: 65,
              minWidth: 50,
            },
            {
            ...
            },
            {
              ...
              accessor: d => parseFloat(d.goalsAgainstPerGame).toFixed(2),
              maxWidth: 65,
              minWidth: 55,
            },
            {
            ...
            },
            {
              ...
              accessor: d => Number(d.powerPlayPercentage).toFixed(1),
              maxWidth: 65,
              minWidth: 55,
            },
            {
              ...
              accessor: d => Number(d.penaltyKillPercentage).toFixed(1),
              maxWidth: 65,
              minWidth: 55,
            },
          ]}
