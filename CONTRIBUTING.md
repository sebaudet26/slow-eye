# Contributing to slow-eye

Love slow-eye and want to help? Thanks so much, there's something to do for everybody!
...
The [issue tracker](https://github.com/alexandresobolevski/slow-eye/issues) is
...
1.  [Fork](https://help.github.com/articles/fork-a-repo/) the project, clone your fork, and configure the remotes:
    ...
    git clone https://github.com/<your-username>/slow-eye.git
    # Navigate to the newly cloned directory
    cd slow-eye
    # Assign the original repo to a remote called "upstream"
    git remote add upstream https://github.com/alexandresobolevski/slow-eye.git
    ```
...
owners to license your work under the terms of the [MIT License](https://github.com/alexandresobolevski/slow-eye/blob/master/LICENSE.md).
